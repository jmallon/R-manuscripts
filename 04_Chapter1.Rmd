...
tab.1_cap <- table_nums(name = "tab_1", 
                        caption = "Here is a regular old table. 
                                  ...
                                  This is a 'pipe' table - note that ':' controls alignment for the whole column.
                                  Lines 3-6 (table content) - note that the spacing here does not change width or 
                                  alignment - but not aligning your text is not advised :).")
